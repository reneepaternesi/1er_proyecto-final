    ...
    <div class="container-fluid nav-bar">
      <b-nav pills>
        ...
        >
          ...
          <b-dropdown-item disabled>Carteras</b-dropdown-item>
          <b-dropdown-item disabled>Indumentaria</b-dropdown-item>
        </b-nav-item-dropdown>
        <b-nav-item>Preguntas Frecuentes</b-nav-item>
        <b-nav-item>Nosotros</b-nav-item>
        <b-nav-item disabled>Login</b-nav-item>
      </b-nav>
    </div>
    <b-button
      v-b-modal.cart
